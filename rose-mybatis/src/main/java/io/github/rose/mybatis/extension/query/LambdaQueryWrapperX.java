 ...
 * @param <T> 数据类型
 */
public class LambdaQueryWrapperX<T> extends LambdaJsonQueryWrapper<T> {
    ...
    public LambdaQueryWrapperX<T> eqIfPresent(SFunction<T, ?> column, Object value) {
        if (ObjectUtils.isNotEmpty(value)) {
            return (LambdaQueryWrapperX<T>) super.eq(column, value);
        }
        return this;
    }
    ...
    public LambdaQueryWrapperX<T> neIfPresent(SFunction<T, ?> column, Object value) {
        if (ObjectUtils.isNotEmpty(value)) {
            return (LambdaQueryWrapperX<T>) super.ne(column, value);
        }
        return this;
    }
    ...
    public LambdaQueryWrapperX<T> gtIfPresent(SFunction<T, ?> column, Object value) {
        if (ObjectUtils.isNotEmpty(value)) {
            return (LambdaQueryWrapperX<T>) super.gt(column, value);
        }
        return this;
    }
