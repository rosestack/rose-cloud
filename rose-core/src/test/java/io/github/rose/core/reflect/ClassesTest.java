...
public class ClassesTest {
    ...
    public void findField() throws Exception {
        assertThat(Classes.from(SubClass.class)
                        .fields()
                        .filter(field -> "subClassField".equals(field.getName()))
                        .findFirst())
                .isEqualTo(Optional.of(subClassField));
        assertThat(Classes.from(SubClass.class)
                        .fields()
        ...
        assertThat(Classes.from(SubClass.class)
                        ...
                        .filter(field -> "baseClassField".equals(field.getName()))
                        .findFirst())
                .isEqualTo(Optional.of(baseClassField));
    }

    @Test
    public void fieldOrderIsBottomUp() throws Exception {
        assertThat(Classes.from(SubClass.class).traversingSuperclasses().fields())
                .containsSubsequence(subClassField, baseClassField);
    }
    ...
    public void methodOrderIsBottomUp() throws Exception {
        ...
        assertThat(result)
                .containsSubsequence(
                        subClassInheritedMethod,
                        someOtherInterfaceMethod,
                        baseClassFromInterfaceMethod,
                        someInterfaceMethod);
        assertThat(result)
                .containsSubsequence(
                        subClassFromInterfaceMethod,
                        someOtherInterfaceMethod,
                        baseClassFromInterfaceMethod,
                        someInterfaceMethod);
    }
    ...
    public void doesNotGoDownHierarchy() throws Exception {
        assertThat(Classes.from(SubClass.class)
                        ...
                        .findFirst())
                .isEqualTo(Optional.of(subClassField));
        assertThat(Classes.from(BaseClass.class)
                        .traversingSuperclasses()
                        .traversingInterfaces()
                        .fields()
                        .filter(field -> "subClassField".equals(field.getName()))
