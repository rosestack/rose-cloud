...
public class WebSecurityConfig {
    ...
    @Bean
    protected RestAccessProcessingFilter restAccessTokenProcessingFilter() {
    ...
    protected RestRefreshProcessingFilter restRefreshProcessingFilter() {
    ...
    private Set<String> getPermitUrlsFromAnnotation() {
        ...
        for (Map.Entry<RequestMappingInfo, HandlerMethod> entry : handlerMethodMap.entrySet()) {
            ...
            if (patternsCondition != null && ObjectUtils.isNotEmpty(patternsCondition.getPatterns())) {
            ...
            if (pathPatternsCondition != null && ObjectUtils.isNotEmpty(pathPatternsCondition.getPatterns())) {
                urls.addAll(pathPatternsCondition.getPatterns().stream()
