...
public class JobScheduleHelper {
            ...
            public void run() {
                ...
                while (!scheduleThreadToStop) {
                    ...
                    try {
                        ...
                        conn = XxlJobAdminConfig.getAdminConfig()
                            .getDataSource()
                            .getConnection();
            ...
            public void run() {
                ...
                while (!ringThreadToStop) {
                    ...
                    try {
                        ...
                        int nowSecond = Calendar.getInstance(TimeZone.getDefault(), Locale.getDefault()).get(Calendar.SECOND); // 避免处理耗时太长，跨过刻度，向前校验一个刻度；
                        for (int i = 0; i < 2; i++) {
    ...
    private void pushTimeRing(int ringSecond, int jobId) {
        ...
        logger.debug(
            ">>>>>>>>>>> xxl-job, schedule push time-ring : " + ringSecond + " = " + Collections.singletonList(ringItemData));
    }
