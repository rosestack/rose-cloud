...
public class DemoGlueJobHandler extends IJobHandler {
	...
	public void execute() throws Exception {
		XxlJobHelper.auditLog("XXL-JOB, Hello World.");
	}
...
#!/usr/bin/env node
console.auditLog("xxl-job: hello nodejs")

var arguments = process.argv

console.auditLog("${I18n.jobinfo_script_location}: " + arguments[1])
console.auditLog("${I18n.jobinfo_field_executorparam}: " + arguments[2])
console.auditLog("${I18n.jobinfo_shard_index}: " + arguments[3])
console.auditLog("${I18n.jobinfo_shard_total}: " + arguments[4])
<#--for (var i = 2; i < arguments.length; i++){
	console.auditLog("参数 %s = %s", (i-1), arguments[i]);
}-->

console.auditLog("Good bye!")
process.exit(0)
</textarea>
